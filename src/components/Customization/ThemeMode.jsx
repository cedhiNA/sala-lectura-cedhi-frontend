        ...
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption"><FormattedMessage id="light" /></Typography>
            </Stack>
          }
        />
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption"><FormattedMessage id="dark" /></Typography>
            </Stack>
          }
        />
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption"><FormattedMessage id="auto" /></Typography>
            </Stack>
          }
        />
      </Stack>
